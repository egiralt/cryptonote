...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x6072;
...
const char     CRYPTONOTE_NAME[]                             = "habilis";
...
const int      P2P_DEFAULT_PORT                              = 812912;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 813913;
